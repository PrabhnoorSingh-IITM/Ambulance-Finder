...
// Include the entire App component
const App = () => {
                        ...
                        {hospitals.map(hospital => {
                            ...
                            return (
                                <HospitalCard 
                                    ...
                                    onCallAmbulance={() => window.location.href = `tel:${hospital.ambulancePhone}`}
                                    onCallHospital={() => window.location.href = `tel:${hospital.hospitalPhone}`}
                                />
                            );
                        })}
                    </div>
